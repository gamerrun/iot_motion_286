...
char ssid[] = "********";                               // Enter your WiFi SSID (router name)
char pass[] = "********";                             // Enter your WiFi router password
unsigned long myChannelNumber = 1236101;                 // Enter your Thingspeak Channel Number
const char * myWriteAPIKey = "ZV42GZAE46Z4ATUL";        // Enter your ThingSpeak API Key
